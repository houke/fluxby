...
export const en: LandingTranslationKeys = {
  ...
  legal: {
    ...
    updatesPage: {
      ...
      v1140F1Desc: 'Review recurring payment changes with help from Jev.',
      v1140F2Title: 'Jev suggestions and ING workbook recognition',
      v1140F2Desc:
        'Jev can now provide suggestions, and ING workbooks are recognized automatically.',
      v1140F3Title: 'Clear a transaction category',
      v1140F3Desc: 'You can now remove a category from a transaction.',
