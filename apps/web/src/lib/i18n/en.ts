...
export const en: TranslationKeys = {
  common: {
    ...
    databaseTakingLonger: 'This is taking longer than expected...',
    databaseInitStatus: {
      starting: 'Starting...',
      resettingDatabase: 'Resetting database...',
      settingUpEncryption: 'Setting up encryption...',
      preparingSecuritySettings: 'Preparing security settings...',
      waitingForUnlock: 'Waiting for unlock...',
      derivingEncryptionKey: 'Deriving encryption key...',
  ...
  errors: {
    ...
    notFoundWelcome: 'Welcome to Fluxby',
    notFoundTitle: 'Page not found',
    appPageIntro: "You're on the app page. Go to the",
    appPageHomeLink: 'home page',
    appPageDashboardPrefix: 'or start with the',
    dashboardLink: 'dashboard',
    landingRouteIntro: 'This page exists in the main menu. Go to',
    landingRouteSuffix: 'on the landing page.',
    defaultNotFoundDescription:
      "The page you're looking for doesn't exist or has been moved.",
    goToDashboard: 'Go to dashboard',
    goBack: 'Go back',
    goToHomePage: 'Go to home page',
    debugResetButton: '🔄 Reset database',
    debugResetConfirm:
      '⚠️ This will delete all app data and reload the page. Continue?',
    debugResetSuccess: '✅ Database cleared. The page will reload.',
    debugResetFailure: '❌ Error: {message}',
  },
  onboarding: {
    seeYouLaterTitle: 'See you later!',
    ...
    settings: {
      ...
      completedDescription:
        'You have completed the tour! You can restart it any time to review all features.',
      inProgressDescription:
        'You are in the middle of the tour. Continue where you left off or restart.',
      introDescription:
        'Discover all Fluxby features with our interactive tour.',
      continue: 'Continue',
      startTour: 'Start tour',
      restart: 'Restart',
      active: 'Tour is active',
      chapters: 'Chapters',
      restartDialogTitle: 'Restart tour',
      restartProfileWarning:
        'Restarting the tour automatically switches you to the Demo profile.',
      createDemoWarning:
  ...
  transactions: {
    ...
    amountMustBePositive: 'Enter a valid positive amount',
    ...
    addTransactionDescription: 'Manually add a transaction to your overview.',
    transactionAdded: 'Transaction added',
    manualCounterparty: 'Counterparty name',
    manualCounterpartyPlaceholder: 'Name of counterparty...',
    orSelectFromAddressBook: 'or select from address book',
    account: 'Account',
    selectAccount: 'Select account',
    amountPlaceholder: '0.00',
    descriptionPlaceholder: 'Description of the transaction...',
    datePlaceholder: 'Select date',
    noPaymentMethod: 'No payment method',
    noAccount: 'No account',
    transferDeposit: 'Deposit',
    transferWithdrawal: 'Withdrawal',
  },
  analytics: {
    title: 'Analytics',
  ...
  import: {
    ...
    analyzingFileDesc: 'Please wait while we process your file',
    finishingUp: 'Finishing up...',
    finishingUpDesc: 'Almost done, just a moment longer',
  ...
  syncDebug: {
    ...
    description: 'Debug tools for PeerJS connectivity. Pairing code format:',
    close: 'Close',
    ...
    connectivityTest: 'Connectivity Test (Simulated)',
    note: 'This ping test is simulated for debugging logs. Test a real connection with the "Pair device" button and a pairing code.',
    ...
    warn: 'Warning',
    error: 'Error',
    sendingPing: 'Sending PING to {peerId}',
    failedPing: 'Failed to send ping: {error}',
  },
  spotlight: {
